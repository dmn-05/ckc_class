...
interface CourseSectionStatsModalProps {
  sectionTitle: string;
  stats: {
    enrolled: number;
    max: number;
...
export default function CourseSectionStatsModal({ sectionTitle, stats, onClose }: CourseSectionStatsModalProps) {
    ...
    <div className={styles.modalOverlay}>
      <div className={styles.modalContent}>
        ...
        <div className={styles.modalBody}>
          ...
          <div style={{ padding: '1rem', backgroundColor: '#e1e0ff', borderRadius: '0.75rem', color: '#2f2ebe', fontSize: '0.875rem', marginTop: '1.5rem' }}>
            <strong>Gợi ý:</strong> Hãy vào xem chi tiết lớp học phần để chấm điểm các bài tập còn tồn đọng hoặc tạo thêm tài nguyên học tập cho sinh viên.
          </div>
        </div>
