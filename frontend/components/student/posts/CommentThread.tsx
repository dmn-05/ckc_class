...
interface CommentThreadProps {
  ...
  currentUser: { id?: number | string, name: string, role: string, avatar?: string | null };
}
      ...
      {comment.isDeleted ? (
        ...
        <div className={`${styles.commentBlock} ${isNested ? styles.commentBlockNested : ''}`}>
          ...
          {comment.authorAvatar ? (
            <img src={comment.authorAvatar} alt={comment.authorName} className={styles.commentAvatar} style={{ objectFit: 'cover' }} />
          ) : (
            <div 
