...
export default function CommentThread({ comment, isNested = false, onReplySubmit, onDelete }: CommentThreadProps) {
  const [isReplying, setIsReplying] = useState(false);

  // If deleted and no replies (or even if it has replies, we show the deleted state)
      ...
      <div className={`${styles.commentBlock} ${isNested ? styles.commentBlockNested : ''}`}>
        ...
        <div className={styles.commentContentArea}>
          ...
          <div className={styles.commentActions}>
            <button className={`${styles.actionBtn} ${styles.actionBtnEdit}`} onClick={() => setIsReplying(!isReplying)}>
