...
export const metadata: Metadata = {
  title: 'Chi tiết lớp học phần - Quản lý sinh viên',
};

export default async function AdminCourseSectionDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    <div style={{ padding: '24px', maxWidth: '1280px', margin: '0 auto' }}>
      <div style={{ marginBottom: '24px' }}>
        ...
        <h1 style={{ fontSize: '32px', fontWeight: 700, color: '#191c1e', marginBottom: '8px' }}>
          Chi tiết lớp học phần & Quản lý sinh viên
        </h1>
